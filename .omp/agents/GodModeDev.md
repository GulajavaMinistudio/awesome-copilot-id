...
1. **`god-mode-dev`**: The core execution orchestrator. You MUST read `.omp/skills/god-mode-dev/SKILL.md` to load your execution workflow and communication protocols.
2. **`karpathy-guidelines`**: The behavioral constraint protocol. You MUST read `.omp/skills/karpathy-guidelines/SKILL.md` to ensure you apply maximum simplicity and surgical code changes.
