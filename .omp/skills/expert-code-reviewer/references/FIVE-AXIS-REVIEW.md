...
> For detailed security review procedures, mandatory use of STRIDE threat modeling, and the full security checklist, **read `.omp/skills/expert-code-reviewer/references/SECURITY-HARDENING.md`** when performing a security-focused review.
