...
3. **Core Rules Discovery:** Read the active platform's corresponding agent definition file for detailed constraints:
   - Path: .github/agents/Diataxis Documentation Architect (or .github/rules/diataxis-documentation-architect.md or .github/agents/diataxis-documentation-architect.toml)
