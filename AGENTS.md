...
- **Readiness Score (0-100):** Every Audit/Clarification Document generated by `@ClarificationAnalyst` or `@ArtifactConsistencyChecker` MUST explicitly evaluate the upstream document (PRD/Spec/Plan) and assign a Readiness Score from 0 to 100 based on the following weighted criteria:
