...
<span class="text-success">> All tests passed (18/18) with 100% coverage!</span>`,
    ...
    install_method0_desc: "Install the `sdlc-init` bootstrapper skill directly using the `npx skills` CLI:",
    ...
    install_skills_info: "<strong>Autonomous & Safe:</strong> The AI agent will autonomously download `AGENTS.md` and `.agents/` folder, merge global rules, and preserve your `memory.instructions.md` notes automatically.",
...
<span class="text-success">> Semua pengujian berhasil (18/18) dengan 100% cakupan!</span>`,
    ...
    install_method0_desc: "Instal bootstrapper skill `sdlc-init` langsung menggunakan CLI `npx skills`:",
    ...
    install_skills_info: "<strong>Otonom & Aman:</strong> Agen AI akan mengunduh `AGENTS.md` dan folder `.agents/` secara otonom, menggabungkan aturan global, serta mengamankan catatan `memory.instructions.md` Anda secara otomatis.",
