...
<span class="text-success">> All tests passed (18/18) with 100% coverage!</span>`,
    ...
    sdlc_slash_desc: "This highly structured workflow uses a dedicated set of slash commands specifically mapped to each SDLC phase (defined in <code>agent-skills-sdlc/AGENTS.md</code>). If you installed this workflow using Option 9 in the installation script (or copied the .agents folder from agent-skills-sdlc/), you now have access to these dedicated SDLC slash commands.",
...
<span class="text-success">> Semua pengujian berhasil (18/18) dengan 100% cakupan!</span>`,
    ...
    sdlc_slash_desc: "Alur kerja terstruktur ini menggunakan set perintah slash khusus yang dipetakan ke setiap fase SDLC (seperti yang didefinisikan dalam <code>agent-skills-sdlc/AGENTS.md</code>). Jika Anda menginstal alur kerja ini menggunakan Opsi 9 pada skrip instalasi (atau menyalin folder .agents dari agent-skills-sdlc/), Anda sekarang memiliki akses ke perintah slash SDLC khusus ini.",
