...
rule_path = r"d:\WebstormProject\awesome-copilot-id\.agents\rules\ClarificationAnalyst.md"
skill_path_old = r"d:\WebstormProject\awesome-copilot-id\.agents\skills\clarification-analyst\SKILL.md"
skill_path_new = r"d:\WebstormProject\awesome-copilot-id\agent-skills-sdlc\.agents\skills\clarify\SKILL.md"
...
# Extract everything after when_to_use
...
# Remove Documentation Standards from workflow if it exists
docs_idx = workflow.find("## Documentation Standards")
if docs_idx != -1:
    workflow = workflow[:docs_idx].strip()

# Remove trailing HR if any
