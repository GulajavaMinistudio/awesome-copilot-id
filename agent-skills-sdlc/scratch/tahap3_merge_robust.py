...
# Fixed regex to capture everything up to Mandatory Template
...
template = robust_cleanup(template)
...
print("Tahap 3 Merge complete with Edge Cases fixed and robust regex")
