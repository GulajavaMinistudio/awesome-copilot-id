...
3. **Core Rules Discovery:** Read the active platform's corresponding agent definition file for detailed constraints:
   - Path: .opencode/agents/Diataxis Documentation Architect (or .opencode/rules/diataxis-documentation-architect.md or .opencode/agents/diataxis-documentation-architect.toml)
