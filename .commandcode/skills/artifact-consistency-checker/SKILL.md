...
3. **Core Rules Discovery:** Read the active platform's corresponding agent definition file for detailed constraints:
   - Path: .commandcode/agents/Artifact Consistency Checker (or .commandcode/rules/artifact-consistency-checker.md or .commandcode/agents/artifact-consistency-checker.toml)
