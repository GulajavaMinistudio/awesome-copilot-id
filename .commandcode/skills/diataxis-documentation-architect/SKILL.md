...
3. **Core Rules Discovery:** Read the active platform's corresponding agent definition file for detailed constraints:
   - Path: .commandcode/agents/Diataxis Documentation Architect (or .commandcode/rules/diataxis-documentation-architect.md or .commandcode/agents/diataxis-documentation-architect.toml)
