...
This document defines the comprehensive review framework for the `/tdd-code-review` skill. Every code review MUST evaluate the submitted code along all five axes below. No axis may be skipped.
...
> For detailed security review procedures, mandatory use of STRIDE threat modeling, and the full security checklist, **read `.agents/skills/tdd-code-review/references/SECURITY-HARDENING.md`** when performing a security-focused review.
