...
3. **Core Rules Discovery:** Read the active platform's corresponding agent definition file for detailed constraints:
   - Path: .claude/agents/ClarificationAnalyst.md
...
You **MUST** use the mandatory clarification report template format when generating the final summary. Read the template from: `.claude/skills/clarification-analyst/references/CLARIFICATION-REPORT-TEMPLATE.md`
