...
2. **Read Mandatory References:** Before writing any code, you MUST read `.agents/skills/god-mode-dev/references/EXECUTION-WORKFLOW.md` and `.agents/skills/god-mode-dev/references/COMMUNICATION-PROTOCOL.md`.
