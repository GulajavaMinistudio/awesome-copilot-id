...
3. **Core Rules Discovery:** Read the active platform's corresponding agent definition file for detailed constraints:
   - Path: .agents/agents/Diataxis Documentation Architect (or .agents/rules/diataxis-documentation-architect.md or .agents/agents/diataxis-documentation-architect.toml)
